    ...
    <ParallaxScrollView
      ...
      headerImage={
        <View style={styles.headerImageContainer}>
          ...
          <LinearGradient
            colors={[Color.transparent, Color.transparent, Color.transparent, Color.transparent, Color.transparent, Color.transparent, Color.overlay]}
            start={{ x: 0, y: 0 }}
            end={{ x: 0.1, y: 0.8 }}
            style={styles.gradientOverlay}
          />
          <LinearGradient
            colors={[Color.transparent, Color.transparent, Color.transparent, Color.transparent, Color.transparent, Color.transparent, Color.overlay_dark]}
            start={{ x: 0, y: 0 }}
            end={{ x: 0.1, y: 1.05 }}
